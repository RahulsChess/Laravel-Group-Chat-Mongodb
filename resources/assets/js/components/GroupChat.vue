    ...
    <div class="panel panel-primary">
            <div class="panel-heading" id="accordion">
                ...
                <div class="btn-group pull-right">
                    <a type="button" class="btn btn-default btn-xs" data-toggle="collapse" data-parent="#accordion-" :href="'#collapseOne-' + group._id">
                        <span class="glyphicon glyphicon-chevron-down"></span>
                    </a>
                </div>
            </div>
            <div class="panel-collapse collapse" :id="'collapseOne-' + group._id">
...
<script>
    export default {
        ...
        methods: {
            store() {
                axios.post('/conversations', {message: this.message, group_id: this.group._id})
                .then((response) => {
                    this.message = '';
            ...
            listenForNewMessage() {
                Echo.private('groups.' + this.group._id)
                    .listen('NewMessage', (e) => {
                        // console.log(e);
